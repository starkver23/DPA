...
/**
 * Generates the Maven pom.xml configuration file for the standalone Spring Boot project.
 */
public class PomGenerator {

    /**
     * Generates a valid pom.xml based on ProjectMetadata.
     *
    ...
    public static String generate(ProjectMetadata metadata) {
        return """
                ...
                <project xmlns="http://maven.apache.org/POM/4.0.0"
                    ...
                    <name>%s</name>
                    <description>Standalone Spring Boot Application generated by CodeClassroom</description>
                    <properties>
